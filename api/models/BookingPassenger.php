...
class BookingPassenger {
     ...
     */
    public function create($bookingId, $passengerId, $passengerType, $fareAmount, $flightSeriesId = null, $flightId = null, $travelDate = null, $leg = 'outbound') {
        try {
            $stmt = $this->db->prepare("
                INSERT INTO booking_passengers 
                (booking_id, passenger_id, passenger_type, fare_amount, flight_series_id, flight_id, travel_date, leg, created_at)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, NOW())
            ");
